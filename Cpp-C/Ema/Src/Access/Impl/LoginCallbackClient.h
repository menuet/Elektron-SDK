...
public :
	...
	static LoginItem* create( OmmBaseImpl&, ClientFunctions*, void*, const LoginList& );
...
private :
	...
	LoginItem( OmmBaseImpl&, ClientFunctions*, void*, const LoginList& );
	LoginItem();
	virtual ~LoginItem();
...
public :
	...
	LoginItem* getLoginItem( const ReqMsg&, ClientFunctions*, void* );
