...
310__MarketByOrder__Streaming is an example of an OMM NiProvider application 
...
310__MarketByOrder__Streaming illustrates how to create and publish a single OMM
item and a source directory. 


Detailed Description
====================

310__MarketByOrder__Streaming implements the following high-level steps:

+ Instantiates and modifies an OmmNiProviderConfig object:
  - which reads in the EmaConfig.xml file
