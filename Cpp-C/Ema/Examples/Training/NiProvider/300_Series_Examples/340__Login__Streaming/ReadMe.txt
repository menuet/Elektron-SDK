...
340__Login__Streaming illustrates how to create and publish one OMM item and
register for and process login events. This application uses source directory
...
+ Publishes updates 1 per second, and
