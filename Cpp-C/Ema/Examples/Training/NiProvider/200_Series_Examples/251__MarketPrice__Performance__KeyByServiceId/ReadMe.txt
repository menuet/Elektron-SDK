...
251__MarketPrice__Performance__KeyByServiceId is an example of an OMM NiProvider application 
...
251__MarketPrice__Performance__KeyByServiceId implements the following high-level steps:
...
+ Creates a number of streaming items (refresh and updates) and publishes them
  - refresh and updates messages use ServiceId instead of ServiceName.
