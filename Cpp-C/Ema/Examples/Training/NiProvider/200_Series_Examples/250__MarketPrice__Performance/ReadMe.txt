...
250__MarketPrice__Performance is an example of an OMM NiProvider application 
...
250__MarketPrice__Performance illustrates how to efficiently create and publish a number
...
250__MarketPrice__Performance implements the following high-level steps:
