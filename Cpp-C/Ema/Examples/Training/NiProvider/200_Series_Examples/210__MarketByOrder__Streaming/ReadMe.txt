...
210__MarketByOrder__Streaming is an example of an OMM NiProvider application 
...
210__MarketByOrder__Streaming illustrates how to create and publish two OMM items. 
...
210__MarketByOrder__Streaming implements the following high-level steps:

+ Instantiates and modifies an OmmNiProviderConfig object:
  - which reads in the EmaConfig.xml file with specified SourceDirectory of TEST_NI_PUB
...
+ Creates streaming items (refresh and updates) and publishes them
  ...
  - MarketByOrder BBQ.V item on the TEST_NI_PUB service
