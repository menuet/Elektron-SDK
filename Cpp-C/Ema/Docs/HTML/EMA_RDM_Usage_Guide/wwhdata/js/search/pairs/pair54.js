...
x.t("confliction","sericeid");
x.t("internals","provider");
x.t("multiple","group");
...
x.t("catagories","added");
x.t("catagories","service");
x.t("added","changed");
x.t("added","updated");
x.t("assigned","client");
x.t("initial","refresh");
...
x.t("map.key","serviceid");
x.t("choose","serviceid");
...
x.t("applications","know");
x.t("comes","source");
x.t("item\u2019s","refresh");
x.t("based","system");
x.t("4.3.1.5","source");
x.t("itself","interactive");
x.t("edition","multiple");
x.t("edition","4.3");
